...
static char *fonts[]          = { "Linux Libertine Mono:size=12", "Mono:pixelsize=12:antialias=true:autohint=true"  };
/* static char *fonts[]          = { "Iosevka, Iosevka Nerd Font:size=12", "Mono:pixelsize=12:antialias=true:autohint=true"  }; */
/* static char *fonts[]          = { "FontAwesome:size=12", "Mono:pixelsize=12:antialias=true:autohint=true"  }; */
